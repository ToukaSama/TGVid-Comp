...
class Config(object):
    ...
    API_HASH  = os.environ.get("API_HASH", "bd08752ff079fbe5f4f8497868b9a40e") # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7789056658:AAFjsVwXDpIwt_xnELHUG22IQLmmoeXnX3Y") # ⚠️ Required
